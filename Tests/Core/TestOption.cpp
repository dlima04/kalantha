...
TEST_CASE("Construct", "[Core.Option]") {
  int num = 20;
  Option<CTORHelper1> obj1(static_cast<int&>(num));
  Option<CTORHelper2> obj2;
...
TEST_CASE("Operators", "[Core.Option]") {
  const Option<CTORHelper2> obj1(200, 400);
  Option<CTORHelper2> obj2(200, 400);
